...
## Methods: 
* Model selection: Split data into test and train datasets and evaluate model performance by mean absolute error (MAE). Evaluate performance of random forest (rf), gradient boosting (gb), and xgboosting (xgb) regressor models.  The rf regressor model had the least MAE.
